    ...
    mapboxgl.accessToken = 'pk.eyJ1Ijoibm9lbHRlY2giLCJhIjoiY2o1dXByYjYxMXJmMTJ3bWxjZXo5YzkydCJ9.ic11CV05aSv7rYdx22nSDw';
  ...
  map.on('load', function() {
   ...
   //add Municipal Fill hover layer
    ...
    map.on("mousemove", "MunicipalFill", function(e) {
        ...
        map.setFilter("MunicipalFillHover", ["==", "NAME_2", e.features[0].properties.NAME_2]);
        }
    });
    ...
    map.on("mousemove", "RegionFill", function(e) {
      if (map.getZoom() <= 8 ){
          map.setFilter("RegionBorderHover", ["==", "Name", e.features[0].properties.Name]);
      }
    });
        // Reset the state-fills-hover layer's filter when the mouse leaves the layer.
    ...
    map.on("mousemove", "ProvinceFill", function(e) {
      if (map.getZoom() > 8 && map.getZoom() <=9  ){
          map.setFilter("ProvinceBorderHover", ["==", "NAME_1", e.features[0].properties.NAME_1]);
      }
    });
        // Reset the state-fills-hover layer's filter when the mouse leaves the layer.
    ...
    map.on("mousemove", "BarangayFill", function(e) {
      if (map.getZoom() > 10.1){
          map.setFilter("BarangayBorderHover", ["==", "NAME_3", e.features[0].properties.NAME_3]);
      }
    });
        // Reset the state-fills-hover layer's filter when the mouse leaves the layer.
...
map.on('mousemove', function(e) {
  switch (true) {
    ...
    if (states.length > 0) {
      document.getElementById('pd').innerHTML = '<h3><strong>' + states[0].properties.Name + '</strong></h3><p><strong><em>' + String(states[0].properties.Population).replace(/(.)(?=(\d{3})+$)/g,'$1,') + '</strong>  People in this Region</em></p>';
    } else {
    ...
    if (states.length > 0) {
      document.getElementById('pd').innerHTML = '<h3><strong>' + states[0].properties.NAME_1 + '</strong></h3><p><strong><em>' + states[0].properties.Population + '</strong>  People in this Province</em></p>';
    } else {
       document.getElementById('pd').innerHTML = '<p>Hover over a region!</p>';
    }
    break;
    ...
    if (states.length > 0) {
      document.getElementById('pd').innerHTML = '<h3><strong>' + states[0].properties.NAME_2 + '</strong></h3><p><strong><em>' + states[0].properties.Population + '</strong>  People in this Municipal/City</em></p>';
    } else {
       document.getElementById('pd').innerHTML = '<p>Hover over a region!</p>';
    }
    break;
    ...
    if (states.length > 0) {
      document.getElementById('pd').innerHTML = '<h3><strong>' + states[0].properties.NAME_3 + '</strong></h3><p><strong><em>' + states[0].properties.Population + '</strong>  People in this Barangay</em></p>';
    } else {
       document.getElementById('pd').innerHTML = '<p>Hover over a region!</p>';
    }
    break;
...
// Show/Hide Legend for specific level
 map.on('zoom', function() {
  ...
  // Displays zoom level
  document.getElementById('zoom-level').innerHTML = '<p style="margin:0;, padding:0;">'+zoom_level+'</p>';
...
map.on('click', function (e) {
  switch (true) {
    case (map.getZoom() <= 8 ):
      ...
      if (states.length > 0){ //popup only when the mouse pointer is at range of feature
        var PopupHTML = '<h3><strong>' + states[0].properties.Name + '</strong></h3><p><strong>' +  states[0].properties.Population +'</strong> People In this Municipality </p> \
    ...
    case (map.getZoom() > 8 && map.getZoom() <=9 ):
      ...
      if (states.length > 0){ //popup only when the mouse pointer is at range of feature
        var PopupHTML = '<h3><strong>' + states[0].properties.NAME_1 + '</strong></h3><p><strong>' +  states[0].properties.Population +'</strong> People In this Municipality </p> \
                <a href="https://.com">Visit AwesomePlace.com</a> <br> \
                <img src="images/molo-church.jpg" alt="Molo Church" height="150" width="200">';
        ShowPopup(e.lngLat,PopupHTML);
      }
    ...
    case (map.getZoom() > 9 && map.getZoom() <=10.1 ):
      ...
      if (states.length > 0){ //popup only when the mouse pointer is at range of feature
        var PopupHTML = '<h3><strong>' + states[0].properties.NAME_2 + '</strong></h3><p><strong>' +  states[0].properties.Population +'</strong> People In this Municipality </p> \
                <a href="https://com">Visit AwesomePlace.com</a> <br> \
                <img src="images/molo-church.jpg" alt="Molo Church" height="150" width="200">';
        ShowPopup(e.lngLat,PopupHTML);
      }
    ...
    case (map.getZoom() > 10.1):
        ...
        if (states.length > 0){ //popup only when the mouse pointer is at range of feature
          var PopupHTML = '<h3><strong>' + states[0].properties.NAME_3 + '</strong></h3><p><strong>' +  states[0].properties.Population +'</strong> People In this Municipality </p> \
                  <a href="https://com">Visit AwesomePlace.com</a> <br> \
                  <img src="images/molo-church.jpg" alt="Molo Church" height="150" width="200">';
          ShowPopup(e.lngLat,PopupHTML);
        }
